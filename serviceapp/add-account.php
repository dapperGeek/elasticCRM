...
<?php
        ...
        if(isset($_POST['btnAddAccount'])){
            ...
            if($name!= "" && $industry != "" && $address != "" && $state != "" && $area != ""
               && $contactN1 != "" && $contactP1 != "" && $contactE1 != "" && $contactD1 != "")
            {

                    if($database->ValidateCompany($name)){
                                            $err = "This company Name has been registered previously";
                                        }else{
                                            //($leadID,$name,$address,$areaID,$contactName1,$contactName2,$contactName3,$phone1,$phone2,$phone3,$email1,$email2,$email3,$desig1,$desig2,$desig3)
                                            $database->createAccounts($leadID,$name,$address,$area,$contactN1,$contactN2,$contactN3,$contactP1,$contactP2,$contactP3,$contactE1,$contactE2,$contactE3,$contactD1,$contactD2,$contactD3,$industry);
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                 <input type="text" name="txtAccountName"
                                                value="<?php if(isset($_POST['txtAccountName'])){ echo $_POST['txtAccountName'];}?>" class="form-control" required>
                </div>
              </div>
              <hr>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <select class="form-control" name="txtIndustry">
                                                ...
                                                ?>
                                                    ...
                                                    <?php if(isset($_POST['txtIndustry']) && $_POST['txtIndustry'] == $machine['id']){echo "selected";}?>><?php echo $machine['sector'];?></option>
                                                <?php }?>
                                                </select>
               ...
               <div class="form-group">
                ...
                <div class="col-lg-3">
                  <input type="text" name="txtContactName2"
                                                value="<?php if(isset($_POST['txtContactName2'])){ echo $_POST['txtContactName2'];}?>" class="form-control" placeHolder="Contact Name" required>

                </div>
                <div class="col-md-2">

                                                <input type="text" name="txtPhone2"
                                                value="<?php if(isset($_POST['txtPhone2'])){ echo $_POST['txtPhone2'];}?>" placeHolder="Contact Phone Number" class="form-control" required>

                                        </div>
                                         <div class="col-md-3">

                                                <input type="text" name="txtEmail2"
                                                value="<?php if(isset($_POST['txtEmail2'])){ echo $_POST['txtEmail2'];}?>" class="form-control" placeHolder="Contact Email" required>

                                        </div>
                                        <div class="col-md-2">

                                                <input type="text" name="txtDesig2"
                                                value="<?php if(isset($_POST['txtDesig2'])){ echo $_POST['txtDesig2'];}?>" placeholder="Designation" class="form-control" required>
               ...
               <div class="form-group">
                ...
                <div class="col-lg-3">
                  <input type="text" name="txtContactName3"
                                                value="<?php if(isset($_POST['txtContactName3'])){ echo $_POST['txtContactName3'];}?>" class="form-control" placeHolder="Contact Name" required>

                </div>
                <div class="col-md-2">

                                                <input type="text" name="txtPhone3"
                                                value="<?php if(isset($_POST['txtPhone3'])){ echo $_POST['txtPhone3'];}?>" placeHolder="Contact Phone Number" class="form-control" required>

                                        </div>
                                         <div class="col-md-3">

                                                <input type="text" name="txtEmail3"
                                                value="<?php if(isset($_POST['txtEmail3'])){ echo $_POST['txtEmail3'];}?>" class="form-control" placeHolder="Contact Email" required>

                                        </div>
                                        <div class="col-md-2">

                                                <input type="text" name="txtDesig3"
                                                value="<?php if(isset($_POST['txtDesig3'])){ echo $_POST['txtDesig3'];}?>" placeholder="Designation" class="form-control" required>
