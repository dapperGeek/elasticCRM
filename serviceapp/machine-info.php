            ...
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    ...
                    ?>
                            ...
                            <a href="<?php echo $host;?>edit-machine/<?php echo $machineInfo['id'];?>" class="btn btn-warning">Edit Machine Information</a>
                    <?php
                        }
                    ?>
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="tab-1">
                            <div class="panel-body">
                                ...
                                <br/>
                                <div class="row">
                                    <div class="col-md-2"><b>METER READING</b></div>
                                    <div class="col-md-4"><?php echo $machineInfo['meterReading']; ?></div>
                        ...
                        <div class="tab-pane" id="tab-2">
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="machineCalls" style="font-size: 12px;" class="display  table  responsive  table-bordered machineCalls table-striped">
                                        <thead>
                                        <tr>
                                            <th>ID</th>
                                            <th>Ticket</th>
                                        ...
                                        if($activities!= null){
                                            ...
                                            foreach($activities as $act){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a target="_blank" href="<?php echo $host;?>ticket-info/<?php echo $act['ticketNo']?>"><?php echo strtoupper($act['ticketNo']);?></a></td>
                        ...
                        <div class="tab-pane" id="tab-3">
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="collectedTbl" class="display  table  responsive  table-bordered machineCalls table-striped table-hover bottom0 ">
                                        <thead>
                                        <tr>
                                            <th>Order #</th>
                                            <th>Order Date</th>
                                        ...
                                        if($myOrder != null){
                                            ...
                                            foreach($myOrder as $mo){
                                                ...
                                                ?>
                                                <tr>
                                                    <td><a target="_blank" href="<?php echo $host;?>purchase-invoice/<?php echo $mo['ticketNo'];?>"><?php echo $mo['ticketNo'];?></a></td>
                        ...
                        <div class="tab-pane" id="tab-4">
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <table id="uncollectedTbl" class="display  table  responsive  table-bordered machineCalls table-striped table-bordered">
                                        <thead>
                                        <tr>
                                            <th>Order #</th>
                                            <th>Order Date</th>
