                        ...
                        ?>
                                        ...
                                        <div class="form-group">
                                            <div class="col-lg-12 col-sm-offset-2">
                                                <?php if($myData['DepartmentID']==6 OR $myData['DepartmentID']==3 OR $myData['DepartmentID']==1){?>
                                                <button class="btn aqua" name="btnFollowUp" class="btn btn-success col-lg-9">PROCESS FOLLOW UP</button><?php } ?>
                                         <?php if($myData['DepartmentID']==3 OR $myData['DepartmentID']==1){?>
...
<?php 
        ...
        ?>
                                        ...
                                        <input type="submit" class="btn btn-primary btn-block" name="closeCall" value="Backdate!">
