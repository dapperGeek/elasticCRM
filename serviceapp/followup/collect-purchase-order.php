...
<div class="modal-dialog modal-lg">
    <div class="modal-content">
        <div class="modal-header" style="text-align: center">
            ...
            <small class="font-bold"><?php echo $accName;?></small>
            <small class="font-bold"><?php echo $m_code;?></small>
        </div>
             ...
             <form method="post">
              <div class="modal-body">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <h4><b>SELECT ORDER CLOSE DATE :</b></h4>
                                            <input type="hidden" name="txtOrderID" value="<?php echo $demand['id'];?>" />
                                            <input type="hidden" name="txtMachineID" value="<?php echo $m_machineID;?>" />
                                            <input type="hidden" name="txtAccountID" value="<?php echo $m_accountID;?>" />
                                        </div>
                                        <div class="col-lg-2">
                                     ...
                                     <div class="row">
                                       <div class="col-lg-4">
                                        ...
                                        <div class="col-lg-6">
                                                  ...
                                                  <select class="form-control" name="txtPaymentMode">
