<?php
    $title = 'Add Showroom Machine';
    $pageHeader = 'addShowroomMachine';
...
?>
 ...
 <?php
         ...
         if(isset($_POST['btnAddShowroomMachine'])){
             ...
             if($acc != "" && $machineCode != "" && $machineModel != ""  && $category != "" && $engineer !== ""){
                         if($database->checkMachineAvailableInShowroom($machineCode)){
                             $err = "This Machine code has been registered previously";}
                         else{
                             $database->createShowroomMachine($acc,$machineCode,$machineModel,$machineSerialNo,$category,$meterReading,$engineer,$doi,$reportedBy);
                             unset($_POST);
                             $msg= "MACHINE HAS BEEN SUCCESSFULLY ADDED TO SHOWROOM INVENTORY";
                             //echo $database->showMsg("SUCCESS",$msg,2);
                             }
                         }
                         else{
                             if($acc == ""){
                                 $err .="<li>Please select an account</li>";
                             }
                             if($machineCode == ""){
                                 $err .="<li>Please enter machine code</li>";
                             }
                             if($machineModel == ""){
                                 $err .="<li>Please Select machine model</li>";
                             }
                             if($machineSerialNo == ""){
                                 $err .="<li>Please enter machine serial No.</li>";
                             }
                             if($Category == ""){
                                 $err .="<li>Please select Category </li>";
                             }
                             if($engineer == ""){
                                 $err.="<li>Please select engineer </li>";
                             }
                         }
                     }
           ...
           <hr/>
             ...
             <div class="form-group">
                <div class="col-sm-4 col-sm-offset-2">
                  ...
                  <button class="btn aqua" type="submit" name="btnAddShowroomMachine" class="btn btn-success col-lg-12">Add Machine to Showroom</button>
                </div>
              </div>
              <hr>
