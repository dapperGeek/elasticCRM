...
<title>Edit Machine | <?php echo $machineInfo['machine_code']." FOR ".$machineInfo['Name'];?></title>
<!-- Bootstrap -->
 ...
 <?php
                             $msg = ""; $err = "";
                                    ...
                                    if($acc != "" && $machineCode != "" && $machineModel != "" && $machineSerialNo != ""
                                        && $contractType != "" && $address != "" && $state != "" && $area != ""
                                        && $contactN1 != "" && $contactP1 != "" && $contactE1 != ""
                                        && $contactD1 != "")
                                    {
             ...
             <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-2">
                  <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"
                                                        ...
                                                        <input class="form-control" type="text" name="txtInD" value="<?php echo $machineInfo['doi'];?>" readonly>
              ...
              <label class="col-sm-2 control-label">CONTRACT START</label>
                <div class="col-sm-2">
                  <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"
                                                        data-link-format="yyyy-mm-dd">
                                                        <input class="form-control" type="text" name="txtCS" value="<?php echo $machineInfo['contractStart'];?>" readonly>
                                                        <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span> <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                                    </div>
                                                    <input type="hidden" id="dtp_input2" value="" />
              ...
              <label class="col-sm-2 control-label">CONTRACT END</label>
                <div class="col-sm-2">
                  <div class="input-group date form_date col-md-12" data-date="" data-date-format="dd MM yyyy" data-link-field="dtp_input2"
                                                        data-link-format="yyyy-mm-dd">
                                                        <input class="form-control" type="text" name="txtCE" value="<?php echo $machineInfo['contractEnds'];?>" readonly>
                                                        <span class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span> <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span></span>
                                                    </div>
                                                    <input type="hidden" id="dtp_input2" value="" />
              ...
              <div class="form-group">
                  ...
                  <select class="form-control m-b" id="parent" name="txtState" onChange="LoadChild();" required data-validation-required-message="State is required">
                                        ...
                                        <script type="text/javascript">
                                            for(var i = 0 ; i < parent.length ; i ++){
                                              if(parent[i][0] == <?php echo $machineInfo['stateID'];?>){
                ...
                <div class="col-sm-5">
                    <select class="form-control m-b" name="txtAreaID" required data-validation-required-message="area is required" id="gchild" onChange="LoadGChild();">
                                <option value="<?php echo $machineInfo['areaID'] ?>"><?php echo $machineInfo['areaname'] ?></option>
              ...
              <div class="form-group">
                ...
                <div class="col-lg-3">
                  <input type="text" name="txtContactName1"
                                                value="<?php echo $machineInfo['contactName1'];?>" placeholder="Contact Name" class="form-control" required>
                </div>
                <div class="col-md-2">

                                                <input type="text" name="txtPhone1"
                                                value="<?php echo $machineInfo['contactPhone1'];?>" placeholder="Contact Phone" class="form-control" required>
                                        </div>
                                         <div class="col-md-3">

                                                <input type="text" name="txtEmail1"
                                                value="<?php echo $machineInfo['contactEmail1'];?>" placeholder="Contact Email" class="form-control" required>

                                        </div>
                                        <div class="col-md-2">

                                                <input type="text" name="txtDesig1"
                                                value="<?php echo $machineInfo['contactDesig1'];?>" placeholder="Contact Designation" class="form-control" required>
               ...
               <div class="form-group">
                ...
                <div class="col-lg-3">
                   <input type="text" name="txtContactName2"
                                                value="<?php echo $machineInfo['contactName2'];?>" placeholder="Contact Phone" class="form-control">
                </div>
                <div class="col-md-2">

                                                <input type="text" name="txtPhone2"
                                                value="<?php echo $machineInfo['contactPhone2'];?>" placeHolder="Contact Phone Number" class="form-control" />

                                        </div>
                                         <div class="col-md-3">

                                                <input type="text" name="txtEmail2"
                                                value="<?php echo $machineInfo['contactEmail2'];?>" class="form-control" placeHolder="Contact Email" />

                                        </div>
                                        <div class="col-md-2">

                                                <input type="text" name="txtDesig2"
                                                value="<?php echo $machineInfo['contactDesig2'];?>" placeholder="Designation" class="form-control" />
               ...
               <div class="form-group">
                ...
                <div class="col-lg-3">
                  <input type="text" name="txtContactName3"
                                                value="<?php echo $machineInfo['contactName3'];?>" class="form-control" placeHolder="Contact Name" />

                </div>
                <div class="col-md-2">

                                                <input type="text" name="txtPhone3"
                                                value="<?php echo $machineInfo['contactPhone3'];?>" placeHolder="Contact Phone Number" class="form-control" />

                                        </div>
                                         <div class="col-md-3">

                                                <input type="text" name="txtEmail3"
                                                value="<?php echo $machineInfo['contactEmail3'];?>" class="form-control" placeHolder="Contact Email" />

                                        </div>
                                        <div class="col-md-2">

                                                <input type="text" name="txtDesig3"
                                                value="<?php echo $machineInfo['contactDesig3'];?>" placeholder="Designation" class="form-control" />
