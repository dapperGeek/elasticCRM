                            ...
                            if(isset($_POST['btnMakePurchase'])){
                               ...
                               $product=$qty=$amount=array();
                                ...
                                if(isset($_POST['txtProduct']) && !empty($_POST['txtProduct'])){
                                     ...
                                     $database->AddNewPurchase($product,$qty,$amount,$machineID,$accountID, $scID,$discount,$serviceCharge);
                                      unset($_POST);
                             ...
                             <table id="tbt"class="table table-striped table-bordered table-advance table-hover">
                                 ...
                                 <tr>
                                  ...
                                  <tr>
                                     ...
                                     <td><input type="text" class="form-control" name="serviceCharge" value="0" id="serviceCharge" /> </td>
                                 </tr>
                                 <tr>
                                     <td colspan="2">
