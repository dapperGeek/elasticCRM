...
<header>
    ...
    <span>
        <img alt="" src="<?php echo $host;?>img/tenaui-logo.jpg" width="120">
        <br/>
        <img alt="" src="<?php echo $host;?>img/canon_logo.png" height="0" width="0">
        <br/>
    </span>
    ...
    <table >
        <tr>
            ...
            <td><span contenteditable>
                    <?php echo $ticket['orderCollectedDate'] != '' ? $ticket['orderCollectedDate'] : 'Uncollected';?></span></td>
        </tr>
        <tr>
...
//            $amount = $accountId == 265 && $order['productID'] == 2496 ? $order['Amount'] : 0;
            $amount = $order['Amount'];
            ?>
            <tr>
...
?>
    ...
    <div class="row">
        ...
        <table class="balance2">
            <tr>
                <th>
                    <span style="font-weight: bold !important;" ><center>Payment Terms</center></span></th>
            </tr>
            <tr>
                <td><center><b>All payments made are non-refundable</b></center></td>
            </tr>
        ...
        <table class="balance">
            ...
            <tr>
                <th><span contenteditable>TRANSPORTATION CHARGE</span></th>
                <td><span data-prefix>
                       <?php
                       $transportCharge = $ticket['transport_charge'];

                       echo $database->convertToMoney($transportCharge);
                       ?>
                        </span></td>
            </tr>
            ...
            <tr>
                ...
                <td><span data-prefix>
                        <?php
                        $sub_total =($amounted) + $sc + $transportCharge;
            ...
            <tr>
                ...
                <td><span data-prefix>
                        ...
                        $vatValue = 0;
                        if($vat == 0){$vatValue == 0;}else{$vatValue = 0.075 * $ServiceChargeWithVAT ;}
...
<div class="row col-lg-12">
    ...
    <table width="100%" border="3">
        <tr>
            <th colspan="2"><em>SPECIAL NOTES AND TERMS OF SALES</em></th>
        </tr>
        <tr>
            <th>PAYMENT TERMS</th>
            <td>100 % advance - Price valid for 7 days</td>
        </tr>
        <tr>
            ...
            <td>
                <table width="100%" border="1">
                    <tr style="text-align: center">
                        ...
                        <th  width="17%">DIAMOND BANK</th>
                        <th  width="17%">GTBANK</th>
                        <th  width="17%">ZENITH BANK</th>
                        <th  width="17%">UBA</th>
                    </tr>
    ...
    <table width="100%" class="borderLess-tbl">
        <tbody>
        <tr>
