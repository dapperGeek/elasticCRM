...
@page { margin: 0; }
        ...
        <article>
             ...
             <table >
               ...
               <textarea  rows="6" cols="99" style=" border: solid"></textarea>
            <table class="inventory">
                <thead>
                    <tr>
                        <th style="width: 5%"><span contenteditable>S/N</span></th>
      ...
      <table>
          ...
          <tr>
              <td><p style="text-align: center">____________________________</p><p style="text-align: center">Engineer Signature</p></td>
                <td><p style="text-align: center">____________________________</p><p style="text-align: center">Customer Signature</p></td>
