...
$ticket = $database->getWorkshopTicket($ticketID);
?>
<html>
    <head>
        <meta charset="utf-8">
...
@page { margin: 0; }
        ...
        <header>
            ...
            <address contenteditable><br/>
                ...
                <strong>Ticket Opened by :<?php echo $ticket['reportedby'];?></strong>
            </address>
        ...
        <article>
             ...
             <table >
                <tr>
                    ...
                    <td><span contenteditable><?php echo $ticket['ticketGen'];?></span></td>
                     <th><span contenteditable>Opened Date</span></th>
                    <td><span contenteditable><?php echo $ticket['dateTime'];?></span></td>
                </tr>
                 <tr>
                    <th><span contenteditable>Account Name</span></th>
                    <td colspan="3"><span contenteditable><?php echo $Name = $ticket['account_name'];?></span></td>
                </tr>
                <tr>
                    <th><span contenteditable>Address</span></th>
                           <?php $AccountName  = $database->getAccountNameInfo($Name); 
                                 
                                

                           ?>
                    <td colspan="3"><span contenteditable><?php echo $AccountName['Address'];?></span></td>
                </tr> 
                <tr>
                    ...
                    <td><span contenteditable><?php echo $ticket['machine_name'];?></span></td>
                </tr>
                <tr>
                     
                    <th><span contenteditable>Engineer Assigned</span></th>
                    <td><span id="prefix" contenteditable><?php echo $ticket['assign_engineer'];?></span></td>
                </tr>
             ...
             <br/>
               ...
               <textarea class="inventory"  rows="12"  style=" width:100%; border: solid"><?php echo strip_tags(nl2br($ticket['Machine_fault']));?>
               </textarea>
