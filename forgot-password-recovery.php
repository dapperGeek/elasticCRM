...
?>
               ...
               <?php
                 ...
                 $database->ForgetPassworRecover($_POST['change_password_button']);
						...
						<div class="col-lg-12">
							<form action="" method="POST" class="top15">
								...
								<div class="form-group">
									<input type="password" name="change_pass" required="" placeholder="New Password" class="form-control">
								</div>

								<div class="form-group">
									<input type="password" name="change_pass_again" required="" placeholder="Re-type New Password" class="form-control">
								</div>
								<button name="change_password_button" class="btn aqua block bottom15" type="submit">Change password</button>
								<a href="login.php" class="btn aqua btn-outline pull-right ">Login</a>
							</form>
						</div>
					</div>
				</div>
