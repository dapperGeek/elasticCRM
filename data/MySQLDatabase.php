...
//        $handle->bindValue(1,$id);
    ...
    public function GoodsLog($product, $added, $transferred, $sold, $returned, $edited, $remain, $storeID, $invoiceNo, $remarks)
    {
        ...
        $handle->bindValue(14, $_SESSION['user_id']);
...
//        WHERE mif.active = 1 and account_id = ?";
 ...
 // echo $user_id." m: ".$month." Y: ".$year;
    ...
    {
        $myArray = array();
        $sql = "select cv.AccID, cv.machineID, cv.RentalCharge, ci.*, mif.machine_code, mif.serialNo 
