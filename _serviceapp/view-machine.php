                  ...
                  <div class="table-responsive">
                    <table id="example7"  class="display nowrap table  responsive nowrap table-bordered">
                      <thead>
                                        ...
                                        ?>
                                            <tr>
                                                 <td><a href="<?php echo $host;?>account-info/<?php echo $machine['account_id']?>"><?php echo strtoupper($machine['Name']);?></a></td>
                                                <td><a href="<?php echo $host;?>machine-info/<?php echo $machine['id']?>"><?php echo $machine['machine_code'];?></a></td>
