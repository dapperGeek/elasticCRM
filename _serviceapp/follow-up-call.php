   ...
   $id = 0;
    ...
    if(isset($_POST['btncollectOrder'])){
         ...
         $vat = $database->test_input($_POST['txtVat']);
            $database->updateOrderCollected($oID,$ocDay,$ocMonth,$ocYear,$vat,$ticket['machine_id'],$ticket['account_id']);
            ...
            <div class="page-content-wrapper">
                <div class="page-content">
                    <div class="row wrapper border-bottom page-heading">
                        <div class="col-lg-12">
                            <h2>12345 Follow Up Call for <?php echo $ticket['ticketNo'];?> | <span class="btn btn-primary"><?php echo $ticket['machine_code'];?></span> |
                                                            ...
                                                            <th colspan="3">
                                                                   ...
                                                                   <div class="btn-group">
                                                                    ...
                                                                    <!-- Large modal -->
                                                                      ...
                                                                      <?php include("followup/collect-purchase-order.php");?>
                                                                    <?php   }else{;?>
                                                                     <div class="btn-group">
