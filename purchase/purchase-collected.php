          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-title">
                <h5>Consumable & Spare Parts sales</h5>
              </div>
                                     ...
                                     <tr>
                                       <td><div class="btn-group">
                                                                     <button data-toggle="dropdown" class="btn btn-info btn-xs dropdown-toggle" type="button"><?php echo $mo['ticketNo'];?>&nbsp;<i class="fa fa-angle-down"></i> </button>
                                                                       ...
                                                                       <li><a href="<?php echo $host;?>ticket-pop/<?php echo $mo['ticketNo'];?>"  data-toggle="modal" data-target="#myModal<?php echo $mo['ticketNo'];?>">PREVIEW </a></li>
                                                                            <li class="divider"> </li>
                            <li> <a href="<?php echo $host;?>purchase-invoice/<?php echo $mo['ticketNo'];?>">SUPPLY TICKET</a></li>
                                                                        </ul>
                                                                    </div>

<div id="myModal<?php echo $mo['ticketNo'];?>"  tabindex="-1" role="dialog" class="modal fade bs-example-modal-lg-2">
                                       ...
                                       <td><?php echo substr($mo['Name'],0,40);?><?php if(strlen($mo['Name'])>40){echo "...";}?></td>
                                        <td><?php echo $mo['machine_code'];?></td>
                                         <td><?php echo $mo['ocDay']."-".$mo['ocMonth']."-".$mo['ocYear'];?></td>
