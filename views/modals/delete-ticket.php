...
<div class="modal fade delete-ticket-modal-<?php echo $prod['id'];?>" tabindex="-1" role="dialog" >
            ...
            <div class="modal-body">
                <div class="invoice">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <select id="catID<?php echo $prod['id'];?>" name="catID<?php echo $prod['id'];?>" class="form-control margin-bottom-5">
                                <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control margin-bottom-5" id="prodName<?php echo $prod['id'];?>" name="prodName<?php echo $prod['id'];?>" value="<?php echo $prod['productName'];?>"/>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input class="form-control margin-bottom-5" id="prodCode<?php echo $prod['id'];?>" name="prodCode<?php echo $prod['id'];?>" value="<?php echo $prod['Code'];?>"/>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-2">&nbsp;</label>
                        ...
                        <div class="col-md-6">
                            <select id="unitID<?php echo $prod['id'];?>" name="unitID<?php echo $prod['id'];?>" class="form-control margin-bottom-5">
                                <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <input id="prodPrice<?php echo $prod['id'];?>" onkeypress="return fun_AllowOnlyAmountAndDot(this.id);" class="form-control margin-bottom-5" onKeyPress="return isNumberKey(event)" name="" value="<?php echo $prod['price'];?>"/>
                        </div>
                    </div>
                    <div class="row">
                        <label class="col-md-2">&nbsp;</label>
