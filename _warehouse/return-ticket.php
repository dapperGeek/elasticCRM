        ...
        <div class="row wrapper border-bottom page-heading">
            <div class="col-lg-12">
                ...
                if(isset($_POST['btnSubmitNewProduct'])){
                    ...
                    $supplier = addslashes($database->test_input($_POST['txtSupplier']));
                    $invoiceNo = $database->test_input($_POST['txtInvoiceNo']);
                    $invoiceReturnDate = str_pad($_POST['txtDayone'],2,"0",STR_PAD_LEFT)."/".str_pad($_POST['txtMonthone'],2,"0",STR_PAD_LEFT)."/".$_POST['txtYearone'];
                    ...
                    $product=$qty=$amount=$unitpro=array();
                    if(isset($_POST['txtProduct'])){
                        $product = $_POST['txtProduct'];
                        $qty = $_POST['txtProductQty'];
                        // $unitpro = $_POST['txtProductPcs'];


                        // $myValue = $database-> getProductNameByProduction($product);
                ...
                if ($storeID > 0){
                    ?>
                    <h1 style="text-align: center"><span class="btn btn-warning">RETURN TICKET FOR WARE HOUSE   -   <?php echo strtoupper($store[1]);?></span></h1>
                    <h4 style="text-align: center">TICKET RETURN BY <?php echo strtoupper($myData['fullname']); ?></h4>
                    <?php
                }
                ?>
...
?>
                                                ...
                                                <div class="col-sm-9">
                                                    <div class="col-md-4">
                                                        <select name="txtDayone" class="form-control">
                                                            <?php for($i=1;$i < 32;$i++){ ?>
                                                                <option <?php if($i == date('d')){echo "selected";}?>>
                                                                    <?php echo $i;?>
                                                                </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <select class="form-control" name="txtMonthone">
                                                            <?php for($i=1;$i < 13;$i++){ ?>
                                                                <option value="<?php echo $i;?>" <?php if($i == date('m')){echo "selected";}?>>
                                                                    <?php echo date('F', mktime(0, 0, 0, $i, 10))?>
                                                                </option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="txtYearone" class="form-control">
                            ...
                            <div class="col-sm-9">
                             <textarea name="txtFileReference" class="form-control m-b"  required data-validation-required-message="File Reference is required"><?php //if(isset($_POST['txtFileReference'])){echo $_POST['txtFileReference'];}?></textarea>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <button type="submit" class="btn btn-success col-lg-12" name="btnSubmitNewProduct"><i class="fa fa-plus-o"></i>RETURN!</button>
                                    </div>
                                </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>All Credit Note for Customer
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <!--  <a href="<?php //echo $host;?>add-product-stock" class="btn btn-success">RECIEVE GOODS</a> -->
                            </h5>
                        </div>
                            ...
                            <div class="widgets-container">
                                <div class="table-responsive">
                                    <table id="example7"  class="display nowrap table  responsive nowrap table-bordered">
                                        ...
                                        $myOrder = (array)$database->getAllReturnTicket();
                                        if($myOrder != null){
                                            ...
                                            foreach($myOrder as $mo){
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="<?php echo $host;?>goods-return-ticket.php?id=<?php echo $mo['ticketGen'];?>" target="_blank"><?php echo str_pad($mo['id'],5,"0",STR_PAD_LEFT);?></a></td>
                                                    <td><?php echo $mo['ticketGen'];?></td>
                                                    <td><?php echo $mo['custormerName'];?></td>
                                                    <td><?php  echo $mo['productName'];?></td>
                                                    <td><?php echo $mo['returned'];?></td>
                                                    <td><?php echo $mo['Code']; ?></td>
                                                    <td><?php echo $mo['invoiceNo'];?></td>
                                                    <td><?php echo $mo['invoiceDate'];?></td>
                                                    <td><?php echo $mo['returnDate'];?></td>
                                                    <td><?php echo $mo['store'];?></td>
                                                    <!--  <td><?php //echo $mo['unit'];?></td> -->
                                                    <td>Returned</td>
