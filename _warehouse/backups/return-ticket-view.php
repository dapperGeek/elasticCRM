  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          <h2>View All Credit Note  </h2>
          <ol class="breadcrumb">
            <li> <a href="">Home</a> </li>
            <li> <a>Credit Note</a> </li>
            <li class="active"> <strong>All Credit Note</strong> </li>
          </ol>
        </div>
                  ...
                  <div class="table-responsive">
                    <table id="example7"  class="display nowrap table  responsive nowrap table-bordered">
                      <thead>
                                    ...
                                    <td><a href="<?php echo $host;?>goods-return-ticket.php?id=<?php echo $mo['id'];?>" target="_blank"><?php echo str_pad($mo['id'],5,"0",STR_PAD_LEFT);?></a></td>
