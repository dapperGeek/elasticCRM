  ...
  <div class="page-content" >
    <div class="row wrapper border-bottom page-heading">
      ...
      <?php
                            if(isset($_POST['btnSubmitNewProduct'])){
                                ...
                                // $invoiceDate = str_pad($_POST['txtDay'],2,"0",STR_PAD_LEFT)."/".str_pad($_POST['txtMonth'],2,"0",STR_PAD_LEFT)."/".$_POST['txtYear'];
                                  ...
                                  if(isset($_POST['txtProduct']) && !empty($_POST['txtProduct'])){
                                        ...
                                        $myValue = $database->UpdateProductCost($product,$cost);

                                        unset($_POST);
                                        $database->showMsg('', "PRODUCT COST HAS BEEN MADE SUCCESSFULLY", 2);
        ...
        <h1 style="text-align: center"><span class="btn btn-warning">ADD PRODUCT COST </span></h1>
         <h4 style="text-align: center">PRODUCT COST ADDED BY <?php echo strtoupper($myData['fullname']); ?></h4>
          ...
          <div class="widgets-container">
                ...
                <div class="col-md-3">
                 ...
                 <div class="col-md-1">
                        ...
                        value="" class="form-control" id="nQty" placeHolder="Cost" required onKeyPress="return isNumberKey(event)" value="1">
                      ...
                      <thead>
                        ...
                        <tr>
                         ...
                         <!-- <th> <i class="fa fa-shopping-cart"></i> Price </th>-->
                          <th> <i class="fa fa-hand-peace-o"></i> Cost </th>
                      ...
                      <tbody>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">&nbsp;</div>
                             <div class="col-md-5">
                                 <button type="submit" class="btn btn-success col-lg-12" name="btnSubmitNewProduct"><i class="fa fa-plus-o"></i>ADD COST!</button>
                            </div>
                        </div>
