...
<title>Transfer Goods Ticket</title>
<!-- Bootstrap -->
                            ...
                            if(isset($_POST['btnSubmitNewProduct'])){
                                ...
                                $invoiceDate = str_pad($_POST['txtDay'],2,"0",STR_PAD_LEFT)."/".str_pad($_POST['txtMonth'],2,"0",STR_PAD_LEFT)."/".$_POST['txtYear'];
                                  ...
                                  if(isset($_POST['txtProduct']) && !empty($_POST['txtProduct'])){
                                      if($i == 0){
                                        $myValue = $database->SellProductStock($supplier,$invoiceNo,$fileRef,$storeID,$product,$qty,$save,$invoiceDate,2);
                                        unset($_POST);
                                        $database->showMsg('', "TRANSFER HAS BEEN MADE SUCCESSFULLY", 2);
                                      }else{$database->showMsg('', "YOU HAVE ADDED THIS PREVIOUSLY", 1);}
                                    }else{
...
$i++;
        ...
        <h1 style="text-align: center"><span class="btn btn-danger">TRANSFER GOODS TICKET FOR WARE HOUSE   -   <?php echo strtoupper($store[1]);?></span></h1>
         <h4 style="text-align: center">GOODS BEEN TRANSFERED BY <?php echo strtoupper($myData['fullname']); ?></h4>
                    ...
                    <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                               <!--  <input type="text" class="form-control m-b"  value="" required data-validation-required-message="Customer Name is required"> -->
                                                   ...
                                                   <select class="form-control m-b" name="txtSupplier">
                                                  <option value="<?php if(isset($_POST['txtSupplier'])){echo $_POST['txtSupplier'];}?>"></option>

                                                <?php    //$Stores = $database->getStoreName(); 
                                                         $Stores = $database->getStoreNameTransferOption($store[0]);

                                                       foreach ($Stores as $Store) {?>
                                     <option value="<?php echo $Store['storeName'];?>"><?php echo $Store['storeName'];?>
                      ...
                      <tbody>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">&nbsp;</div>
                             <div class="col-md-5">
                                 <button type="submit" class="btn btn-WARNING col-lg-12" name="btnSubmitNewProduct"><i class="fa fa-plus-o"></i>TRANSFER!</button>
                            </div>
                        </div>
                      ...
                      <thead>
                                     ...
                                     <tr>
                                              ...
                                              <!--   <td><?php //echo $mo['FileReference'];?></td> -->
                                                ...
                                                <td><?php echo $mo['invoiceNo'];?></td>
                                                <td><?php echo date('jS F Y', strtotime(str_ireplace('/', '-', $mo['invoiceDate'])));?></td>
