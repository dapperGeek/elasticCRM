  ...
  <div class="page-content-wrapper">
    <div class="page-content">
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          <h2>View Goods Recieved Tickets </h2>
          <ol class="breadcrumb">
            <li> <a href="">Home</a> </li>
            <li> <a>Goods Recieved Tickets</a> </li>
            <li class="active"> <strong>All Goods Recieved</strong> </li>
          </ol>
        </div>
          ...
          <div class="col-lg-12">
            <div class="ibox float-e-margins">
              <div class="ibox-title">
                <h5>All Invoice Recieved for WareHouse
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                     ...
                     <?php if($myData['DepartmentID'] == 5){?>
                        ...
                        <?php }else{?>
                    <a href="<?php echo $host;?>add-product-to-stock" class="btn btn-success">RECIEVE GOODS</a>
                  ...
                  <div class="table-responsive">
                    <table id="example7"  class="display nowrap table  responsive nowrap table-bordered">
                      <thead>
                                        ...
                                        $myOrder = (array)$database->getAllGoodsRecieved();
                                            if($myOrder != null){
                                     ...
                                     <tr>
                                                ...
                                                <td><a href="<?php echo $host;?>goods-recieved-ticket/<?php echo $mo['id'];?>" target="_blank"><?php echo str_pad($mo['id'],5,"0",STR_PAD_LEFT);?></a></td>
