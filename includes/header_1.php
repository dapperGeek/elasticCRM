                        ...
                        <div class="page-sidebar">
                                <ul class="page-sidebar-menu  page-header-fixed ">
                                        ...
                                        <li class="nav-item">
                                                ...
                                                <ul class="sub-menu">
                                                        <li class="nav-item">
                                                                <a class="nav-link" href="<?php echo $host;?>add-account"> <span class="title">Add Account</span> </a>
                                                        </li>
                                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                                ...
                                                <ul class="sub-menu">
                                                        <li class="nav-item">
                                                                <a class="nav-link" href="<?php echo $host;?>add-machine"> <span class="title">Add Machine </span> </a>
                                                        </li>
                                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                                ...
                                                <ul class="sub-menu">
                                                        ...
                                                        <li class="nav-item">
                                                                <a class="nav-link" href="<?php echo $host;?>add-contract"> <span class="title">Create Contract</span> </a>
                                                        </li>
                                                        <li class="nav-item">
