            ...
            <div class="tabs-container">
              ...
              <div class="tab-content">
                <div class="tab-pane active" id="tab-1">
                  ...
                  <h2><?php echo $machineInfo['Name']; ?> <a href="<?php echo $host;?>generate-billing/<?php echo $id;?>" class="btn btn-success">genrate billing</a></h2>
                    <?php $mpsorder = (array)$database->getLeadMPSOrderOnLeadDemand($id);
                        $n = 1;
                        $total_amount = 0;
                        $totalValue = 0;
                     ?>
