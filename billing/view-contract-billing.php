...
<div class="page-content-wrapper animated fadeInRight">
    <div class="page-content">
        <div class="row wrapper border-bottom page-heading">
            <div class="col-lg-12">
                <h2>View All Contracts Billing Information</h2>
                <ol class="breadcrumb">
                    <li> <a href="index-2.html">Home</a> </li>
                    <li> <a>Billing</a> </li>
                    <li> <a>Cotracts</a> </li>
                    <li class="active"> <strong>View All Contracts Billing Information</strong> </li>
                </ol>
            </div>
                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>View All Contracts Billing Information</h5>
                        </div>
                        <div class="ibox-content collapse in">
                            <div class="widgets-container">
                                <div class="table-responsive">
                                    <table id="example7" class="table table-bordered table-hover bottom0 ">
                                        <thead>
                                        <tr>
                                            <th>Order #</th>
                                            <th>Account</th>
                                        ...
                                        $myOrder = (array)$database->getContractBillingValuesaLL();
                                        if($myOrder != null){
