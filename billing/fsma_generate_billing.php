            ...
            <form method="post">
                ...
                <table style="font-size: smaller" class="display nowrap table  responsive nowrap table-bordered">
                    <tr>
                        ...
                        <th rowspan="2">COST MONO</th>
                        <th rowspan="2">COST COLOR</th>
                    ...
                    foreach($getcont as $getconts){
                        ...
                        <tr>
                            ...
                            ?>
                            <td class="success"><b><?php echo $database->convertToMoney($getconts['cost_mono']);?></b></td>
                            <td><b style="color:BLUE"><b><?php echo $database->convertToMoney($getconts['cost_color']);?></b></td>
                            <?php
                            ...
                            <td><?php
                                ...
                                ?>
<!--                                <input type="text" class="form-control" value="--><?php //echo $colorval;?><!--" readonly="readonly" size="5" id="pcolor--><?php //echo $getconts['machineID'];?><!--" name="pcolor[]"/>-->
        ...
        <th colspan="11" style="text-align: right" <?php if($machineInfo['cummulative'] == 1){echo "style='display:none;";}?>>TOTAL PAYABLE</th>
        ...
        <script>
            ...
            function checkMonoPrint(vali){
                ...
                if(copyMade < min){
                    bill = bill;
                }else if(copyMade > min && copyMade < excess){
                    bill = cost * copyMade;
