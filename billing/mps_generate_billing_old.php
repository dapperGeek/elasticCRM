                     ...
                     ?>
                        <tr>
                            ...
                            <input type="hidden" value="<?php echo $getconts['RentalCharge'];?>" name="txtRental[]" />
                               ...
                               <?php
                                        $total_min_mono =  $machineInfo['cummulative'] == 1
                                            ? $getconts['min_vol_mono']
                                            : $total_min_mono + $getconts['min_vol_mono'];

                                        $total_min_color =  $machineInfo['cummulative'] == 1
                                           ? $getconts['min_vol_color']
                                           : $total_min_mono + $getconts['min_vol_color'];
